/* 
 * This file is a test harness for the lab 0 parser. It takes in
 * commands from standard in, passes them to the parser, and outputs
 * the parsed version in a standardized format for unit testing.
 */
...
int main(int argc, char **argv, char **envp)
{
    ...
    do
    {
        ...
        if (infile) printf("Input redirection to file [%s]\n", infile);
        if (outfile) printf("Output redirection to file [%s]\n", outfile);
